<h1 align="center"> 🚀 Analogic Clock | Vanilla </h1>

## ✍️ Descrição
Exemplificação de aplicação de relógio analógico usando vanilla ou Javascript puro
...
1. Clone:
    ...
    ```bash
    git clone git@github.com:cleibp/analogic-clock-vanilla.git
    ```
1. Download:
    ### Download Manual
...
[Publicação em Codepen](https://codepen.io/cleibp/pen/MWZoGOK) 
